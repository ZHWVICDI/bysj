...
document.write('<link rel="stylesheet" type="text/css" th:herf="@{settings/style.css}">');
document.write('<script type="text/javascript"  th:src="@{settings/js/jquery.cookies.min.js}"></script>');
document.write('<script type="text/javascript"  th:src="@{settings/js/main.js}"></script>');
/* settings block end */
